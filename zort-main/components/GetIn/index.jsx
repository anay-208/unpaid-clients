        ...
        <div className="flex flex-col justify-center items-center relative pb-[100px] px-[1.5rem] sm:px-[3rem] xl:px-[140px] 2xl:px-[215px] pt-[1.875rem]">
            <div className="absolute -top-[100px] left-0 w-full h-full flex justify-between items-between">
                <div className="mt-[1400px] md:mt-[600px] absolute left-0 max-w-[1000px]">
                    <Image alt="" width={1600} height={1406} src="/images/getin/leftbg.webp" />
                </div>
                <div className="mt-[200px] md:mt-[50px] absolute right-0 max-w-[1000px]">
                    <Image alt="" width={1600} height={1406} src="/images/getin/rightbg.webp" />
                </div>
            </div>
                ...
                <div className="flex flex-col relative justify-center items-center bg-[#16181B80] rounded-[1.5rem] max-w-[380px] m-[1rem]">
                    <div className="flex flex-col justify-center mb-[1.25rem]">
                        <div className="ml-[1.25rem] mt-[3.125rem] h-[124px]">
                            <Image alt="" width={121} height="100" src="/images/getin/bear.svg" layout="fixed" />
                        </div>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem] mt-[2rem]">
                            ...
                            <button className='w-full rounded-full border-[2px] px-[1.25rem] py-[1.125rem] text-[1.125rem] leading-[1.125rem] font-medium text-[#D7314F] border-[#D7314F] hover:bg-[#D7314F] hover:text-white  h-[64px]'>
                                Join Arena
                            </button>
                        </div>
                    </div>
                ...
                <div className="flex flex-col relative justify-center items-center bg-[#16181B80] rounded-[1.5rem] max-w-[380px] m-[1rem]">
                    <div className="flex flex-col justify-center mb-[1.25rem]">
                        <div className="mr-[1.25rem] mt-[3.125rem] h-[124px]">
                            <Image alt="" width={119} height="118" src="/images/getin/bull.svg" layout="fixed" />
                        </div>
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem] mt-[2rem]">
                            ...
                            <button className='w-full rounded-full border-[2px] px-[1.25rem] py-[1.125rem] text-[1.125rem] leading-[1.125rem] font-medium text-[#B9F70A] border-[#B9F70A] hover:bg-[#B9F70A] hover:text-black h-[64px]'>
                                Join Arena
                            </button>
                        </div>
                    </div>
