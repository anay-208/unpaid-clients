    ...
    return (
        <div className="relative flex flex-col justify-center items-center pb-[3.125rem] ">
            <div className='absolute w-full h-full flex -top-[100%]'>
                <Image alt='' layout='fill' width={1600} height={982} src="/images/footer/bg.webp"/>
            ...
            <div className='w-full justify-center mt-[1.25rem] hidden md:flex'>
                <button className='flex relative px-[25px]'>
                    <div>
                        <Image alt="instagram" width={98} height={98} src="/images/footer/instagram.webp" />
                    </div>
                ...
                <button className='flex relative px-[25px]'>
                    <div>
                        <Image alt="instagram" width={107} height={94} src="/images/footer/twitter.webp" />
                    </div>
                    <div className='absolute w-full h-full flex items-center justify-center pb-[1.875rem] pr-[3.125rem]'>
                ...
                <button className='flex relative px-[25px]'>
                    <div>
                        <Image alt="instagram" width={106} height={87} src="/images/footer/youtube.webp" />
                    </div>
                    <div className='absolute w-full h-full flex items-center justify-center pb-[1.875rem] pr-[3.125rem]'>
                ...
                <button className='flex relative px-[25px]'>
                    <div>
                        <Image alt="instagram" width={100} height={91} src="/images/footer/telegram.webp" />
                    </div>
                    <div className='absolute w-full h-full flex items-center justify-center pb-[1.875rem] pr-[3.125rem]'>
