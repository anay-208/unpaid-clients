    ...
    return (
        <div className="relative mt-[3.125rem] flex flex-col lg:flex-row w-full max-w-[1100px]">
            <div className="absolute left-0 top-0 w-full h-full hidden lg:block">
                <Image alt="" width={1170} height={510} src="/images/hero/background.webp" layout="responsive"/>
            </div>
            {/* <div className="pb-[100px] lg:hidden block">
                <Image alt="" width={600} height={839} src="/images/hero/background_2.webp" layout="fixed"/>
            </div> */}
            {/* <div className="absolute -top-[35px] left-[2.5rem] lg:top-[100px] lg:left-[1.25rem]">
                <div className="absolute -left-[100px] -top-[1.25rem] w-full">
                    <Image alt="" src="/images/hero/rect_5.webp" width={602} height={504} layout="fixed" />
                </div>
                <div className="w-[410px] h-[286px] flex flex-col justify-center items-center relative z-10 text-white text-[1.125rem]">
                    <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem]">
                        <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center mr-[.5rem]">
                            <Image alt="" width={30} height={30} src="/images/hero/u1.webp" />
                        </div>
                    ...
                    <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem]">
                        <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center mr-[.5rem]">
                            <Image alt="" width={30} height={30} src="/images/hero/u2.webp" />
                        </div>
                        <p className="grow"> cryptoDreamer</p>
                        <p> $ 800.00</p>
                    </div>
                    <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem]">
                        <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center mr-[.5rem]">
                            <Image alt="" width={30} height={30} src="/images/hero/u3.webp" />
                        </div>
                        <p className="grow"> cryptoDreamer</p>
                        <p> $ 280.00</p>
                    </div>
                    <div className="flex items-center w-full px-[2.5rem] mb-[1.125rem]">
                        <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center mr-[.5rem]">
                            <Image alt="" width={30} height={30} src="/images/hero/u4.webp" />
                        </div>
                        <p className="grow"> cryptoDreamer</p>
                        <p> $ 210.00</p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 h-full">
                <Image alt="" src="/images/hero/place.svg" width={755} height={713} layout="responsive"/>
            </div>
            <div className="w-full lg:w-1/2 z-10 p-[2.5rem] -mt-[120px] md:-mt-[150px] lg:-mt-[20px] ">
                <p className="text-[#A7ADB4] text-[26px] sm:32px xl:text-[24px] leading-[30px] sm:leading-[42px]">
                    Welcome to Zort Trading Arena, a <span className="text-white text-[28px]">decentralized trading platform</span> merging analytics, binary, crypto derivatives, and leveraging, with on-chain smart contract data verification
                </p>
            </div>
            {/* <div className="absolute top-[150px] left-[200px] lg:top-[260px] lg:left-[220px] z-30">
                <div className="absolute -left-[35px] w-full">
                    <Image alt="" src="/images/hero/rect_6.webp" width={410} height={400} layout="fixed" />
                </div>
