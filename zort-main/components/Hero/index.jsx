...
export default function Hero() {
  return (
    <div className="relative w-full flex justify-center  overflow-hidden h-fit mb-[5rem] px-[1.5rem] sm:px-[3rem] xl:px-[140px] 2xl:px-[215px] ">
      <div className="absolute top-0 left-0 w-full flex justify-between">
        {/* <Image priority  alt="" src="/images/hero/back.webp" width={1600} height={1456} layout="responsive" /> */}
        <div className="max-w-[40%] mt-[50vh] xl:mt-[20vh]">
          <Image
            priority
            alt=""
            src="/images/hero/redline.svg"
            width={933}
            height={1442}
          />
        </div>
      ...
      <div className="flex flex-col w-fit items-center z-10">
        <h2 className="text-[4.5rem] leading-[5rem] md:leading-[6rem] md:text-[5.5rem] text-white max-w-[800px] text-center mt-[76px] z-0 -tracking-[1.5px]">
          Ready to test your{" "}
          <span className="text-[#B9F70A]">crypto intuition</span>?{" "}
        </h2>
        {/* <div className="relative flex w-fit">
                    <div className="relative mr-[150px] pb-[160px]">
                        <div className="absolute ml-[1.25rem] -top-[3.125rem]">
                            <Image priority  alt="" width={275} height={286} src="/images/hero/red_back.webp" layout="fixed" />
                        </div>
                        <div className="z-20 relative pl-[60px] md:pl-[1.875rem] md:pl-[0px]">
                            <Image priority  alt="" width={246} height={238} src="/images/hero/red_animal.webp" layout="fixed" />
                        </div>
                    </div>
                    <div className="absolute top-[150px] left-[180px] sm:left-[120px] md:left-[3.125rem]">
                        <div className="absolute -left-[110px] -top-[1.125rem] w-full">
                            <Image priority  alt="" src="/images/hero/rect_2.webp" width={554} height={442} layout="fixed" />
                        </div>
                        <div className="w-[334px] h-[224px] flex flex-col justify-center items-center relative z-10">
                            <div className="flex mb-[1.25rem]">
                                <div className="rounded-full bg-[#292B2D] w-[3.125rem] h-[3.125rem] flex items-center justify-center">
                                    <Image priority  alt="" width={50} height={50} src="/images/hero/bitcoin.webp" />
                                </div>
                            </div>
                            ...
                            <div className="flex justify-center">
                                <button className="relative w-[120px] h-[54px] flex justify-center items-center mr-[.875rem]">
                                    <div className="absolute left-0 top-0 w-[120px] h-[54px]">
                                        <Image priority  alt="" layout="fill" src="/images/hero/green_btn.webp" />
                                    </div>
                                    <p className="text-white z-10"> Up </p>
                                </button>
                                <button className="relative w-[120px] h-[54px] flex justify-center items-center">
                                    <div className="absolute left-0 top-0 w-[120px] h-[54px]">
                                        <Image priority  alt="" layout="fill" src="/images/hero/red_btn.webp" />
                                    </div>
                    ...
                    <div className="absolute -top-[.625rem] left-[240px] md:top-[1.875rem] md:left-[260px]">
                        <div className="absolute -left-[6.5rem] w-full">
                            <Image priority  alt="" src="/images/hero/rect_1.webp" width={339} height={322} layout="fixed" />
                        </div>
                        <div className="w-[179px] h-[163px] flex flex-col justify-center items-center relative z-10">
                            <div className="flex mb-[.625rem]">
                                <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center">
                                    <Image priority  alt="" width={30} height={30} src="/images/hero/u1.webp" />
                                </div>
                                <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center -ml-[.5rem]">
                                    <Image priority  alt="" width={30} height={30} src="/images/hero/u3.webp" />
                                </div>
                                <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center -ml-[.5rem]">
                                    <Image priority  alt="" width={30} height={30} src="/images/hero/u3.webp" />
                                </div>
                                <div className="rounded-full bg-[#292B2D] w-[1.875rem] h-[1.875rem] flex items-center justify-center -ml-[.5rem]">
                                    <Image priority  alt="" width={30} height={30} src="/images/hero/u4.webp" />
                                </div>
                            </div>
                    ...
                    <div className="absolute top-[200px] sm:top-[230px] left-[420px] z-10">
                        <div className="absolute -left-[00px] w-full">
                            <Image priority  alt="" src="/images/hero/rect_3.webp" width={184} height={121} layout="fixed" />
                        </div>
                    ...
                    <div className="relative">
                        <div className="-mt-[75px]">
                            <Image priority  alt="" width={288} height={304} src="/images/hero/green_back.webp" layout="fixed" />
                        </div>
                        <div className="absolute top-0 right-[60px] md:right-[41px]">
                            <Image priority  alt="" width={254} height={264} src="/images/hero/green_animal.webp" layout="fixed" />
                        </div>
                    </div>
                </div> */}
        <div  className="-mt-16 md:-mt-32 lg:-mt-36">
          <Image
            priority
            alt=""
            width={873}
        ...
        <div className="flex flex-col sm:flex-row justify-center mb-[3.125rem] z-20 text-[1.25rem] leading-[28px]">
          <button className="rounded-full border-[1px]  border-[#B9F70A] hover:bg-[#B9F70A] hover:text-black transition py-[1.125rem] px-[2.5rem] text-[#B9F70A] font-Inter mx-[.625rem] mb-[1.25rem] md:mb-[0px]">
            Join Us
          </button>
          <a
            href="#howitworks"
            className="rounded-full border-[1px] py-[1.125rem] px-[2.5rem] text-white hover:bg-white hover:text-black font-Inter mx-[.625rem] mb-[1.25rem] md:mb-[0px] transition"
          >
            How it works?
          </a>
        </div>
